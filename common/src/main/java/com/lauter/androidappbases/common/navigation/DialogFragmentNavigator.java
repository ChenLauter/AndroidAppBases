package com.lauter.androidappbases.common.navigation;
 ...
 * <code>android:name</code> or {@link androidx.navigation.fragment.DialogFragmentNavigator.Destination#setClassName(String)}.
 */
@Navigator.Name("dialog")
public final class DialogFragmentNavigator extends Navigator<androidx.navigation.fragment.DialogFragmentNavigator.Destination> {
    ...
    public androidx.navigation.fragment.DialogFragmentNavigator.Destination createDestination() {
        return new androidx.navigation.fragment.DialogFragmentNavigator.Destination(this);
    }
    ...
    /**
     * NavDestination specific to {@link androidx.navigation.fragment.DialogFragmentNavigator}.
     */
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(androidx.navigation.fragment.DialogFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link androidx.navigation.fragment.DialogFragmentNavigator} which this destination
         *                          will be associated with. Generally retrieved via a
         *                          {@link NavController}'s
         *                          {@link NavigatorProvider#getNavigator(Class)} method.
         */
        public Destination(@NonNull Navigator<? extends androidx.navigation.fragment.DialogFragmentNavigator.Destination> fragmentNavigator) {
         ...
         *                  destination
         * @return this {@link androidx.navigation.fragment.DialogFragmentNavigator.Destination}
         */
        @NonNull
