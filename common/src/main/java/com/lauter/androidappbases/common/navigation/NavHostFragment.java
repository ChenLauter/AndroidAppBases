...
public class NavHostFragment extends Fragment implements NavHost {
     ...
     */
    @NonNull
    public static androidx.navigation.fragment.NavHostFragment create(@NavigationRes int graphResId) {
    ...
    public static androidx.navigation.fragment.NavHostFragment create(@NavigationRes int graphResId,
        ...
        final androidx.navigation.fragment.NavHostFragment result = new androidx.navigation.fragment.NavHostFragment();
        if (b != null) {
     ...
     * <p>
     * By default, this adds a {@link androidx.navigation.fragment.FragmentNavigator}.
     * <p>
    ...
    @Deprecated
    @NonNull
    protected Navigator<? extends androidx.navigation.fragment.FragmentNavigator.Destination> createFragmentNavigator() {
